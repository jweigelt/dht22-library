...
void loop() {
	...
	if (!dht.update()) {
		...
		/*
		* lastH() and lastT() will return cashed values aquired during the last update
		* rel. Humidity is returned in percent, multiplied by 100 (50.4% would be 504)
		* Temperature is returned in °C, multiplied by 100 (21.5°C would be 215)
		*/
